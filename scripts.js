...
document.addEventListener("DOMContentLoaded", function() { var loginForm = document.getElementById("loginForm"); if (loginForm) {
    ...
    if (username === "admin" && password === "1234") { window.location.href = "dashboard.html";
    } else {
    ...
    // Aquí podrías añadir lógica para almacenar el usuario registrado // En este ejemplo, simplemente mostramos un mensaje de éxito alert("Usuario registrado: " + newUser); window.location.href="index.html";
    //En este ejemplo, simplemente mostramos un mensjae de éxito
...
var linkEstudiantes = document.getElementById("linkEstudiantes"); var linkAsignaturas = document.getElementById("linkAsignaturas");
var contenedorEstudiantes = document.getElementById("contenedorEstudiantes"); var contenedorAsignaturas = document.getElementById("contenedorAsignaturas");
linkEstudiantes.addEventListener("click", function(event) { event.preventDefault();
});
contenedorEstudiantes.classList.add("active"); contenedorAsignaturas.classList.remove("active");
